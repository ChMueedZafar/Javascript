...
console.log(numb1 + "is divsible by 5 and 11:" + isdivisibleby5and11(numb1));
console.log(numb2 + "is divsible by 5 and 11:" + isdivisibleby5and11(numb2));
console.log(numb3 + "is divsible by 5 and 11:" + isdivisibleby5and11(numb3));
...
// Test the function
let inputt = prompt("Enter an alphabet:");
let resultt = checkVowelOrConsonant(inputt);
...
//     // Available denominations (replace with your currency denominations)
//     const notes = [1000, 500, 100, 50, 20, 10, 5, 1];
  
//     // Initialize the number of notes for each denomination
//     const noteCounts = new Array(notes.length).fill(0);
  
//     // Greedy approach to minimize the number of notes
//     for (let i = 0; i < notes.length; i++) {
//       if (amount >= notes[i]) {
//         // Use the maximum number of notes for the current denomination
//         noteCounts[i] = Math.floor(amount / notes[i]);
...
//   console.log("Minimum number of notes for each denomination:");
//   for (let i = 0; i < minNotes.length; i++) {
